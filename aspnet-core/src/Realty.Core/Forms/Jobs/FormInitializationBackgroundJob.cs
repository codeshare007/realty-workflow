...
{
    internal class FormInitializationBackgroundJob: 
        AsyncBackgroundJob<FormInitializationBackgroundJobArgs>, 
        ITransientDependency
    {
        ...
        public FormInitializationBackgroundJob(
        ...
        [UnitOfWork]
        protected override async Task ExecuteAsync(FormInitializationBackgroundJobArgs args)
        {
