...
namespace Realty.MultiTenancy.Demo
{
    /// <summary>
    ...
    /// </summary>
    public class TenantDemoDataBuilder : RealtyServiceBase, ITransientDependency
    {
        ...
        private async Task BuildForInternalAsync(Tenant tenant)
        {
            ...
            foreach (var user in users)
            {
                ...
                //Add to roles
                await _userManager.AddToRoleAsync(user, StaticRoleNames.Tenants.Agent);
