...
namespace Realty.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : RealtyServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Realty", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
