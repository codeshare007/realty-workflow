...
using Realty.Url;
using Realty.Web.Public.Startup;
using Realty.Web.Session;

namespace Realty.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : RealtyViewComponent
    {
