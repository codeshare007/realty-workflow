...
using Realty.Auditing.Exporting;
using Realty.Authorization;
using Realty.Authorization.Users;
using Realty.Dto;
using Realty.EntityHistory;
using EntityHistoryHelper = Realty.EntityHistory.EntityHistoryHelper;

namespace Realty.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : RealtyAppServiceBase, IAuditLogAppService
    {
