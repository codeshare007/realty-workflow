...
using Realty.DemoUiComponents.Dto;

namespace Realty.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : RealtyAppServiceBase, IDemoUiComponentsAppService
    {
