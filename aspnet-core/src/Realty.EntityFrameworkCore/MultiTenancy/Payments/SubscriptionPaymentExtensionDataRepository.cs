...
{
    public class SubscriptionPaymentExtensionDataRepository : RealtyRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<RealtyDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
