...
namespace Realty.Migrations
{
    ...
    [Migration("20201222083655_Add_AgentId_To_User")]
    partial class Add_AgentId_To_User
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Realty.Forms.Controls.FormControl", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("FormControlValueId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FormControlValueId")
                        .IsUnique()
                        .HasFilter("[FormControlValueId] IS NOT NULL");
            ...
            modelBuilder.Entity("Realty.Forms.Controls.FormControlValue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Realty.Forms.FormPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Realty.Transactions.TransactionForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Realty.Forms.Controls.FormControl", b =>
                {
                    b.HasOne("Realty.Forms.Controls.FormControlValue", "Value")
                        .WithOne()
                        .HasForeignKey("Realty.Forms.Controls.FormControl", "FormControlValueId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Realty.Forms.FormPage", null)
                        .WithMany("Controls")
                    ...
                    b.OwnsOne("Realty.Forms.Controls.FormControlFont", "Font", b1 =>
                        {
                            b1.Property<long>("FormControlId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
                                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                            ...
                            b1.HasKey("FormControlId");

                            b1.ToTable("FormControls");

                            b1.WithOwner()
                                .HasForeignKey("FormControlId");
                        });

                    b.OwnsOne("Realty.Forms.Controls.FormControlPosition", "Position", b1 =>
                        {
                            b1.Property<long>("FormControlId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
                    ...
                    b.OwnsOne("Realty.Forms.Controls.FormControlSize", "Size", b1 =>
                        {
                            b1.Property<long>("FormControlId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Realty.Forms.FormPage", b =>
                {
                    ...
                    b.HasOne("Realty.Forms.Form", "Form")
                        .WithMany("Pages")
            ...
            modelBuilder.Entity("Realty.Leads.RecommendedListing", b =>
                {
                    ...
                    b.HasOne("Realty.Leads.Lead", null)
