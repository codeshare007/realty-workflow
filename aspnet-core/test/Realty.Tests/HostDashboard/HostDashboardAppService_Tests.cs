...
using Realty.MultiTenancy.HostDashboard;
...
namespace Realty.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(RealtyDbContext context, SubscriptionPayment subscriptionPayment)
        {
