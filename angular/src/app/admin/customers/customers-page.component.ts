...
export class CustomersPageComponent extends AppComponentBase implements OnInit, AfterViewInit, OnDestroy {
    ...
    deleteUser(user: UserListDto): void {
        ...
        this.message.confirm(
            ...
            (isConfirmed) => {
                if (isConfirmed) {
                    this._userServiceProxy.deleteUser(user.id, undefined, this.userRole)
                        .subscribe(() => {
                            this.reloadPage();
