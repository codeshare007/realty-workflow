...
@Component({
    selector: 'email-listings-modal',
    templateUrl: './email-listings-modal.component.html'
})
export class EmailListingsModalComponent extends AppComponentBase {

    @ViewChild('emailListingsModal', { static: true }) modal: ModalDirective;
