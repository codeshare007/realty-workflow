...
export class FormLibraryReportService {
  ...
  downloadReport(id: string, filename: string, callback: () => void) {
  ...
  private loadReport$(id: string): Observable<Blob> {
    const url = '/Printsigning/PrintLibraryForm?id=' + id;
